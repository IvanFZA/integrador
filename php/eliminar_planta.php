...
<head>
    ...
    <link rel="stylesheet" href="CSS/targeta.css"> <!-- Enlace al archivo de estilos CSS -->
</head>
<body>
<div class="container mt-5">
    ...
    if ($result->num_rows > 0) {
        echo "<h2 class='text-center mb-4'>Selecciona una Planta para Eliminar</h2>";
        echo "<div class='row'>";
            ...
            <div class='col-md-4'>
                <div class='card mb-4'>
                    ...
                    <div class='card-body'>
                        ...
                        <button class='btn btn-danger' onclick='confirmarEliminar($id_planta)'>Eliminar</button>
                    </div>
                </div>
            </div>";
        }
